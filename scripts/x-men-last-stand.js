...
popupUpmovieName.defaultValue = "X-men The Last Stand";
...
const closePopup = () => {
    ...
    if (popupUpmovieName.value === "") {
        ...
        updateHeader.forEach((i) => i.innerHTML = "X-Men The Last Stand");
    } else if (popupUpmovieName.value === "X-Men The Last Stand") {
